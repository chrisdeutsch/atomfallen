...
\begin{frame}{Vergleich der Fallen}
	...
	\begin{tabular}{l | p{4cm} | p{4cm}}
		...
		\hline
		typ. Fallentiefen: & $\sim \SI{1e6}{K}$ & $\sim \SI{1}{K}$ \\
		min. Temperatur: & $\sim \SI{1}{mK}$ & $\sim \SI{100}{\micro\kelvin}$ \\
		&&\\
		Vor- / Nachteile: & Ionen & neutrale Atome \\
		& \textcolor{Green}{zustandsunabhängig} & \textcolor{Red}{zustandsabhängig} \\
		& \textcolor{Red}{Heizeffekt aufgrund der RF} & \textcolor{Green}{Kühlung durch opt. Melasse} \\
